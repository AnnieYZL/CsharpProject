...
namespace SV21T1080067.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        /// <summary>
        /// Lấy thông tin của một mặt hàng được bán trong đơn hàng ( 1 chi tiết trong đơn hàng)
        /// </summary>
        /// <param name="orderID"></param>
        ...
        public static bool EditAdress(int orderID, string deliveryProvince, string deliveryAddress)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
