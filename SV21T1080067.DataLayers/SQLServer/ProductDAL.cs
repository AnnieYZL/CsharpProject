        ...
        public int Add(Product data)
        {
            ...
            using (var connection = OpenConnection())
            {
                var sql = @"insert into Products(ProductName,ProductDescription,SupplierID,CategoryID,Unit,Price,Photo,IsSelling)
                                values(@ProductName,@ProductDescription,@SupplierID,@CategoryID,@Unit,@Price,@Photo,@IsSelling);select @@IDENTITY";
                var parameters = new
                {
        ...
        public long AddAttribute(ProductAttribute data)
        {
            ...
            using (var connection = OpenConnection())
            {
                var sql = @"insert into ProductAttributes(ProductID,AttributeName,AttributeValue,DisplayOrder)
                               values(@ProductID,@AttributeName,@AttributeValue,@DisplayOrder);select @@IDENTITY";
                var parameters = new
                {
        ...
        public long AddPhoto(ProductPhoto data)
        {
            ...
            using (var connection = OpenConnection())
            {
                var sql = @"insert into ProductPhotos(ProductID,Photo,Description,DisplayOrder,IsHidden)
                                 values(@ProductID,@Photo,@Description,@DisplayOrder,@IsHidden);select @@IDENTITY";
                var parameters = new
                {
                    ProductID = data.ProductID,
                    Photo = data.Photo ?? "",
