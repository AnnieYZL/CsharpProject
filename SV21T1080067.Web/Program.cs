...
string connectionString = @"server=ANNIEYZL\ANNIE;user id = sa;password=123;database= LiteCommerceDB;TrustServerCertificate=true";
SV21T1080067.BusinessLayers.Configuration.Initialize(connectionString);
